  ...
  Widget build(BuildContext context) {
    ...
    return RawMaterialButton(
      ...
      constraints: BoxConstraints(
          maxHeight: getSize(boxConstraints.maxHeight),
          maxWidth: getSize(boxConstraints.maxWidth),
          minHeight: getSize(boxConstraints.minHeight),
          minWidth: getSize(boxConstraints.minWidth)),
