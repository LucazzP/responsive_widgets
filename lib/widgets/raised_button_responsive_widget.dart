  ...
  Widget build(BuildContext context) {
    ...
    return RawMaterialButton(
      ...
      constraints: BoxConstraints(
          maxHeight: getSizeByDp(boxConstraints.maxHeight),
          maxWidth: getSizeByDp(boxConstraints.maxWidth),
          minHeight: getSizeByDp(boxConstraints.minHeight),
          minWidth: getSizeByDp(boxConstraints.minWidth)),
